...
public class tutoIndexer {
  ...
  public static void main() throws IOException {
    ...
    tutoIndexer indexer = null;
    try {
      indexLocation = s;
      indexer = new tutoIndexer(s);
    } catch (Exception ex) {
    ...
    IndexReader reader = DirectoryReader.open(FSDirectory.open(Paths.get("tindex")));
   ...
   // System.out.println(collector.toString());
    ...
    while (!s.equalsIgnoreCase("q")) {
        ...
        //yukaridaki 3 satir icin farkli try/catch yap.
        //asagidaki for bloku icin farkli try catch yap.
        // 4. display results
        ...
        for(int i=0;i<hits.length;++i) {
          ...
          theJpgPath=theJpgPath.replace(".xml", ".jpg");
          theJpgPath=theJpgPath.replace("annotations","images");
          System.out.println("  theJpgPath: "+theJpgPath);
          indexer.ImageDemo(theJpgPath);
          
          }
        }
        //ayni fotograflari almak icin:"inca" querry'sini gir.
       catch (Exception e) {
   ...
   */
  tutoIndexer(String indexDir) throws IOException {
    // the boolean true parameter means to create a new index everytime, 
    // potentially overwriting any existing files there.
    FSDirectory dir = FSDirectory.open(Paths.get("tindex"));
  ...
  private void addFiles(File file) {
    ...
    if (file.isDirectory()) {
      ...
      //===================================================
      // Only index text files, added .eng support.
      //===================================================
      if (filename.endsWith(".htm") || filename.endsWith(".html") || 
              filename.endsWith(".xml") || filename.endsWith(".txt") || filename.endsWith(".eng")) {
        queue.add(file);
      } else {
...
//bir search yaptiktan sonra bir daha search yapilamakta, bunu duzelt
  //github'a push'la!!
  /**
   * Close the index.
